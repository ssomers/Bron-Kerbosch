...
[<Test>]
let Difference () =
    Assert.That(VertexSet.difference empty one, Is.Empty)
    Assert.That(VertexSet.difference empty two, Is.Empty)
    Assert.That(VertexSet.difference empty six, Is.Empty)
