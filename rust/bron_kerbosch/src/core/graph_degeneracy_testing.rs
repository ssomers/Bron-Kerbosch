...
use crate::core::slimgraphfactory::SlimUndirectedGraphFactory;
use crate::{Adjacencies, UndirectedGraphFactory, Vertex, VertexSetLike};
use proptest::prelude::*;
use proptest::test_runner::{Config, TestRunner};

pub fn test_degeneracy_order<VertexSet: VertexSetLike + Clone>() {
