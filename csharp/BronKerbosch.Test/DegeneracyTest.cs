...
namespace BronKerbosch.Test
{
        ...
        where TVertexSetMgr : IVertexSetMgr<TVertexSet>
    {
        ...
        {
            var g = Order0.Graph;
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter(), Is.Empty);
        }
        ...
        public void TestOrder2_connected()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(1));
        }
        ...
        public void TestOrder3_size2()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(2));
        }
        ...
        public void TestOrder4_size3_bus()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(3));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First(), Is.AnyOf([Vertex.Nth(0), Vertex.Nth(3)]));
        }
        ...
        public void TestOrder4_size3_star()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(3));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First, Is.Not.EqualTo(Vertex.Nth(0)));
        }
        ...
        public void TestOrder4_size4_p()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(3));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First, Is.EqualTo(Vertex.Nth(0)));
        }
        ...
        public void TestOrder4_size5()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(3));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First, Is.AnyOf([Vertex.Nth(1), Vertex.Nth(3)]));
        }
        ...
        public void TestOrder5_size6_penultimate()
        {
            ...
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(4));
        }
        ...
        {
            var g = Sample.Graph;
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(6));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First, Is.AnyOf([Vertex.Nth(6), Vertex.Nth(7)]));
        }
        ...
        {
            var g = Bigger.Graph;
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().Count, Is.EqualTo(9));
            Assert.That(new Degeneracy<TVertexSet, TVertexSetMgr>(g).Iter().First, Is.AnyOf([Vertex.Nth(5), Vertex.Nth(8)]));
        }
    }
}
